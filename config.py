...
LOGGER_ID = int(getenv("LOGGER_ID", -1002359036545))
OWNER_USERNAME = getenv("OWNER_USERNAME","MUNNA_KING_XD")
CHAT_GROUP = getenv("CHAT_GROUP", "https://t.me/Love_dp_Sad_dp")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+Vr47TRT5Vbw2YjA9")
